...
def call(args):
    ...
    return (
        ...
        buf3,
        buf7,
        reinterpret_tensor(buf5, (5, 7), (1, 5), 0),
        reinterpret_tensor(primals_4, (4, 5), (1, 4), 0),
        reinterpret_tensor(primals_3, (5, 8), (1, 5), 0),
        reinterpret_tensor(primals_7, (4, 8), (8, 1), 0),
        reinterpret_tensor(buf1, (5, 7), (1, 5), 0),
