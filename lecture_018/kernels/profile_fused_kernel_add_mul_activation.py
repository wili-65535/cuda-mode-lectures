import torch
from triton_fused_add_mul_activation import (fused_add_mul_activation_torch, get_inputs)
...
if __name__ == '__main__':
    ...
    prof = torch.profiler.profile(
        ...
        on_trace_ready=torch.profiler.tensorboard_trace_handler("kernel_benchmarks", worker_name="triton_vs_torchscript"),
        profile_memory=True,
        with_stack=True
    )
    prof.start()
