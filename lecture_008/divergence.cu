...
void benchmarkKernel(void (*kernel)(int *, int), int *data, int N,
...
int main() {
  ...
  benchmarkKernel(processArrayWithDivergence, data, N,
                  "processArrayWithDivergence");
  benchmarkKernel(processArrayWithoutDivergence, data, N,
                  "processArrayWithoutDivergence");
